# BLOCKRIFT Colyseus server

Authoritative WebSocket room server for the public BLOCKRIFT browser game.

- Fixed 60 Hz room simulation; clients send 12-byte inputs, never positions.
- One delta-encoded `@colyseus/schema` patch per client every 50 ms (20 Hz) during live matches; waiting and finished rooms use a 1 Hz heartbeat.
...
- Eight-player private rooms, bot-filled Quick Play, automatic deployment, and 20-second reconnection.
